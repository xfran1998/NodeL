...
/*
 * "Prime Numbers" — Demo flow
 *
 * Finds all prime numbers up to max_prime using nested loops,
 * stores them in an array, and displays them via a user-defined function.
 */

export const initialNodes: Node[] = [
  { id: 'start', type: 'start', position: { x: -460, y: 0 }, data: {} },
  { id: 'set-1771957019083', type: 'set', position: { x: -220, y: 0 }, data: { inlineValues: { value: '100' }, variable: 'max_prime', valueType: 'number' } },
  { id: 'for-1771957050056', type: 'for', position: { x: 320, y: 0 }, data: { inlineValues: { from: '2', step: '1' } } },
  { id: 'for-1771957106494', type: 'for', position: { x: 1260, y: 80 }, data: { inlineValues: { from: '2', step: '1' }, variable: 'j' } },
  ...
  { id: 'arrayPush-1771957737224', type: 'arrayPush', position: { x: 2900, y: 160 }, data: { variable: 'primes' } },
  { id: 'arrayCreate-1771957786871', type: 'arrayCreate', position: { x: 60, y: 0 }, data: { variable: 'primes' } },
  { id: 'set-paste-1771957852046-0', type: 'set', position: { x: 740, y: 80 }, data: { inlineValues: { value: 'false' }, variable: 'possible_prime', valueType: 'number' } },
  { id: 'get-1771958065557', type: 'get', position: { x: 2640, y: 280 }, data: { variable: 'possible_prime' } },
  { id: 'callFunction-1771958192360', type: 'callFunction', position: { x: 620, y: -20 }, data: { functionId: 'fn-1771958139364', inlineValues: { 'p-1771958140718': 'primes' } } },
];
...
export const initialEdges: Edge[] = [
  ...
  { id: 'e-set-1771957019083-out-value-for-1771957050056-to', type: 'data', source: 'set-1771957019083', sourceHandle: 'out-value', target: 'for-1771957050056', targetHandle: 'to', data: { dataType: 'any' } },
  ...
  { id: 'e-divide-1771957117609-result-for-1771957106494-to', type: 'data', source: 'divide-1771957117609', sourceHandle: 'result', target: 'for-1771957106494', targetHandle: 'to', data: { dataType: 'number' } },
...
export const initialFunctions: Record<string, FunctionDef> = {
  'fn-1771958139364': {
    ...
    name: 'ShowPrimes',
    color: '#8b5cf6',
    params: [{ id: 'p-1771958140718', name: 'primes', dataType: 'array' }],
    returns: [],
    nodes: [
      { id: 'functionEntry-1771958139364', type: 'functionEntry', position: { x: -380, y: 100 }, data: { functionId: 'fn-1771958139364' } },
      { id: 'output-paste-1771958154715-0', type: 'output', position: { x: 900, y: 180 }, data: { inlineValues: { value: 'primes' } } },
      { id: 'arrayLength-paste-1771958154715-1', type: 'arrayLength', position: { x: 0, y: 180 }, data: { variable: 'primes' } },
      { id: 'for-paste-1771958154715-2', type: 'for', position: { x: 320, y: 100 }, data: { inlineValues: { from: '0', step: '1' } } },
      { id: 'arrayGet-paste-1771958154715-3', type: 'arrayGet', position: { x: 620, y: 220 }, data: { variable: 'primes' } },
    ],
    edges: [
      ...
      { id: 'e-arrayLength-paste-1771958154715-1-value-for-paste-1771958154715-2-to', type: 'data', source: 'arrayLength-paste-1771958154715-1', sourceHandle: 'value', target: 'for-paste-1771958154715-2', targetHandle: 'to', data: { dataType: 'number' } },
